...
// 导入 actionCreators
import { increment, decrement, decrementAsync, fetchData } from '../../actions/cart'
                            ...
                            cartList.map(item => {
                                return (
                                    <tr key={item.id}>
                                        ...
                                        <td>
                                            <button onClick={
                                                this.props.decrementAsync.bind(this, item.id)
                                            }>等一会再减</button>
                                            <button onClick={
...
export default connect(mapState, { increment, decrement, decrementAsync, fetchData })(CartList)